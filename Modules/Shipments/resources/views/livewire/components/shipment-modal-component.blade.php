        ...
        <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
            ...
            <form wire:submit.prevent="save" class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div id="accordion-collapse">
                    ...
                    <h2>
                        <button type="button" @if($form->isOrderInfoValid()) wire:click="toggleSection(1)" @else disabled @endif class="flex justify-between items-center py-4 px-4 w-full font-medium leading-none text-left text-gray-900 bg-gray-50 sm:px-5 dark:border-gray-700 dark:text-white hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600">
                        ...
                        <div class="p-8 border-gray-200 sm:p-5 dark:border-gray-700">
                            ...
                            <div class="grid gap-4 sm:grid-cols-2">
                                <div>
                                    ...
                                    @error('form.brand_id')
                                    <p cl   ass="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium"></span> {{ $message }}</p>
                                    @enderror
                                </div>
                    ...
                    <h2>
                    <button type="button" @if($form->isOrderInfoValid()) wire:click="toggleSection(2)" @else disabled @endif class="flex justify-between items-center py-4 px-4 w-full font-medium leading-none text-left text-gray-900 bg-blue-500 border-t border-gray-200 sm:px-5 dark:border-gray-700 dark:text-white hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600">
                    ...
                    <h2>
                        <button type="button" @if($form->isOrderInfoValid() && $form->isBillingValid()) wire:click="toggleSection(3)" @else disabled @endif class="flex justify-between items-center py-4 px-4 w-full font-medium leading-none text-left text-gray-900 bg-blue-500 border-t border-gray-200 sm:px-5 dark:border-gray-700 dark:text-white hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600">
                    ...
                    <h2>
                        <button type="button" @if($form->isOrderInfoValid() && $form->isBillingValid() && $form->isDeliveryValid()) wire:click="toggleSection(4)" @else disabled @endif class="flex justify-between items-center py-4 px-4 w-full font-medium leading-none text-left text-gray-900 bg-blue-500 border-t border-gray-200 sm:px-5 dark:border-gray-700 dark:text-white hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600">
                ...
                <div class="flex items-center py-4 px-4 space-x-4 sm:px-5">
                    <button @disabled(!$form->isOrderInfoValid() && !$form->isBillingValid() && !$form->isDeliveryValid()) type="submit" class="w-full text-white inline-flex items-center justify-center bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 disabled:bg-green-400 dark:disabled:bg-green-300 disabled:opacity-75">
                    ...
                    <button wire:click="close" type="button" class="w-full inline-flex justify-center text-gray-500 items-center bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-primary-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">
                        Discard
                    </button>
                </div>
                @endif
